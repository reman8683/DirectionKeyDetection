...
scoreboard players operation in dirkeyTemp = _z dirkey
scoreboard players operation in1 dirkeyTemp = _x dirkey
function dirkey:calc/atan2
scoreboard players operation _dir dirkey = out dirkeyTemp
scoreboard players operation _dir dirkey += _ry dirkey

## Map angle to the range 0..360
scoreboard players operation _dir dirkey %= #360 dirkeyPrime
